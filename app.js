...
window.onload = () => {
	...
	client.on("message", (channel, tags, message, self) => {
		if (
			...
			message.includes("mokokoGiggle") ||
			message.includes("gigl") ||
			message.includes("KEKWPoint") ||
			message.includes("icent") ||
			message.includes("xddICANT") ||
			message.includes("xdding")
		) {
			switch (true) {
				case message.includes("KEKWPoint"):
					if (!emoteImg.src.includes("KEKWPoint.png")) {
						emoteImg.src = "./img/KEKWPoint.png";
				...
				case message.includes("OMEGALUL"):
					...
					break;
				case message.includes("xddICANT"):
					if (!emoteImg.src.includes("xddICANT.png")) {
						emoteImg.src = "./img/xddICANT.png";
						emoteImg.classList.remove("swing-in-top-fwd");
						emoteImg.offsetWidth;
						emoteImg.classList.add("swing-in-top-fwd");
					}
					break;
				case message.includes("xdding"):
					if (!emoteImg.src.includes("xdding.png")) {
						emoteImg.src = "./img/xdding.png";
						emoteImg.classList.remove("swing-in-top-fwd");
						emoteImg.offsetWidth;
						emoteImg.classList.add("swing-in-top-fwd");
					}
				...
				case message.includes("laff"):
					...
					break;
				case message.includes("gigl"):
					if (!emoteImg.src.includes("gigl.png")) {
						emoteImg.src = "./img/gigl.png";
						emoteImg.classList.remove("swing-in-top-fwd");
						emoteImg.offsetWidth;
						emoteImg.classList.add("swing-in-top-fwd");
					}
					break;
				case message.includes("mokokoGiggle"):
					if (!emoteImg.src.includes("mokokoGiggle.png")) {
						emoteImg.src = "./img/mokokoGiggle.png";
						emoteImg.classList.remove("swing-in-top-fwd");
						emoteImg.offsetWidth;
						emoteImg.classList.add("swing-in-top-fwd");
					}
					break;
				case message.includes("icent"):
					if (!emoteImg.src.includes("icent.png")) {
						emoteImg.src = "./img/icent.png";
						emoteImg.classList.remove("swing-in-top-fwd");
						emoteImg.offsetWidth;
						emoteImg.classList.add("swing-in-top-fwd");
					}
